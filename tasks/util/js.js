 ...
 */
export function collectUsedBabelHelpers(tr, usedBabelHelpers) { /* eslint consistent-return: 0 */
 ...
 * @param {String[]} usedBabelHelpers - The array of babel helpers, passed by reference
 */
export function writeBabelHelpers(usedBabelHelpers) { /* eslint max-statements: 0 */
